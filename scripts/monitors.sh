...
then
    bash -c /home/o5-14/.config/i3/monitors/SingleMon.sh
elif [ "$selected_option" == "$monRight" ]
then
    bash -c /home/o5-14/.config/i3/monitors/DualMonR.sh
...
then
    bash -c /home/o5-14/.config/i3/monitors/TVMonL.sh
elif [ "$selected_option" == "$tvLivingRoom" ]
then
    bash -c /home/o5-14/.config/i3/monitors/LivingRoomTV.sh
else
    echo "No match"
fi
